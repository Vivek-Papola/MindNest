        ...
        <div key={index} className="mb-4 text-black font-bold m-12">
          ...
          <div className="flex flex-col space-y-2">
            {options.map((option, optionIndex) => (
              <label
                key={optionIndex}
                className={`flex items-center p-3 px-5 block cursor-pointer rounded-full border border-black border-opacity-20 ${hoveredOption === `${index}-${option}` ? 'hover:bg-black hover:text-white' : 'hover:bg-gray-200'}`}
